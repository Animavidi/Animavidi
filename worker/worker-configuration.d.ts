/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/worker-configuration.d.ts` (hash: d05980500d6ba4772e23d47b5ef19de2)
// Runtime types generated with workerd@1.20260826.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	MAMMAL_PHOTOS: R2Bucket;
	ADMIN_ALLOWED_ORIGINS: "https://animavidi.com,https://www.animavidi.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_ALLOWED_ORIGINS" | "MEDIA_BASE_URL" | "ADMIN_USERNAME" | "ADMIN_PASSWORD_HASH" | "ADMIN_SESSION_SECRET">> {}
}
